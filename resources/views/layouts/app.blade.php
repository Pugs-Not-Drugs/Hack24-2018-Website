    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="header-menu">                
                ...
                <div class="col-sm-5">
                    <div class="header-right" style="float: right; padding: 35px;">
                        <a href="https://telegram.me/Ecobot_bot" target="_blank" style="margin-right: 20px">
                            <img src='/images/telegram.png' style="max-height: 30px;">
                        </a>
                        <a href="#" style="margin-right: 20px">
                            <img src='/images/tweeter.png' style="max-height: 30px;">
                        </a>
                        <a href="#">
                            <img src='/images/messenger.png' style="max-height: 30px;">
                        </a>
                    </div>
                </div>
            </div>
